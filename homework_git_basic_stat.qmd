...
The p-value obtained from the two-sample t-test is 0.0003134, which is less than the significance level of 0.05. Therefore, we reject the null hypothesis and conclude that there is a significant difference between the mean DRP scores of the treatment and control groups.
